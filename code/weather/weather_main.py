...
params = {
	...
	"end_date": "2025-07-04",
	"daily": ["weather_code", "sunrise", "sunset", "daylight_duration", "temperature_2m_max", "temperature_2m_min", "temperature_2m_mean", "apparent_temperature_mean", "rain_sum", "showers_sum", "snowfall_sum", "precipitation_hours"],
